...
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}1" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-3 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}2" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-4 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}3" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-5 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}4" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-6 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}5" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-7 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}6" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-8 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}7" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-9 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}8" &
...
cd '/home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d.runfiles/drake/'
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}1" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=3e-3 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}2" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-3 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}3" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=3e-4 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}4" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-4 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}5" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=3e-5 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}6" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-5 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}7" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=3e-6 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="finalbox${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}8" &
...
#time bazel run --config snopt //examples/box:integrator_benchmark  -- --simulation_time 2.5 --v_stiction_tolerance 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff=false --max_time_step=1.7e-5 --fixed_step=$FIXED --box_v0 0.0 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr48" 

#time bazel run --config snopt //examples/box:integrator_benchmark  -- --simulation_time 2.5 --v_stiction_tolerance 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff=false --max_time_step=2.4e-5 --fixed_step=$FIXED --box_v0 0.0 --truth_integration_scheme="runge_kutta3" --fixed_tolerance=1e-9 --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr47"
