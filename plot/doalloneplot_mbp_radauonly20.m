...
% normstyle = 'both';
tttt = read_scheme('radau', true, true, true, true, normstyle);
tttf = read_scheme('radau', true, true, true, false, normstyle);
...
time = result8(:, 1);
if(1)
figure(); plot(time, result1(:,[7 10])); title('friction comparison step size 2.5e-2 vs truth') 
figure(); plot(time, result2(:,[7 10])); title('friction comparison step size 1e-2 vs truth') 
figure(); plot(time, result3(:,[7 10])); title('friction comparison step size 3e-3 vs truth') 
figure(); plot(time, result4(:,[7 10])); title('friction comparison step size 1e-3 vs truth') 
figure(); plot(time, result5(:,[7 10])); title('friction comparison step size 3e-4 vs truth') 
figure(); plot(time, result6(:,[7 10])); title('friction comparison step size 1e-4 vs truth') 
%figure(); plot(time, result7(:,[7 10])); title('friction comparison step size 3e-6 vs truth')
end
if(1)
figure(); plot(time, result1(:,[6 9])); title('velocity comparison largest step vs truth') 
figure(); plot(time, result2(:,[6 9])); title('velocity comparison second largest step vs truth')
figure(); plot(time, result3(:,[6 9])); title('velocity comparison third largest step vs truth')
figure(); plot(time, result4(:,[6 9])); title('velocity comparison fourth largest step vs truth')
figure(); plot(time, result5(:,[6 9])); title('velocity comparison fifth largest step vs truth')
figure(); plot(time, result6(:,[6 9])); title('velocity comparison sixth largest step vs truth')
%figure(); plot(time, result7(:,[6 9])); title('velocity comparison seventh largest step vs truth')
end
