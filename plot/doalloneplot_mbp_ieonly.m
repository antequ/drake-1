...
p = loglog(tttf{1}, tttf{2}, '-kx', ...
    ...
    ttft{1}, ttft{2}, '--kv', ...
    ftff{1}, ftff{2}, '-k^', ...
    ftft{1}, ftft{2}, '--k^', 'MarkerSize', 6, 'LineWidth', 1);
p(2).LineWidth = 1.5;
p(4).LineWidth = 1.5;
p(6).LineWidth = 1.5;
p(8).LineWidth = 1.5;
...
lgd = legend('Full Newton (FN)', 'FN with TALS', 'Error-Ctrled (EC) FN', 'EC FN with TALS',...
       'Quasi Newton (QN)', 'QN with TALS', 'EC QN', 'EC QN with TALS');
...
saveas(fig, '/home/antequ/integratorplots/workprecisionfull.pdf')
% bottom right
fig = figure();
p = loglog(tttf{1}(1:8), tttf{2}(1:8), '-ko', ...
    tttt{1}(1:8), tttt{2}(1:8), '--ko', ...
    fttf{1}(1:8), fttf{2}(1:8), '-ks', ...
    fttt{1}(1:8), fttt{2}(1:8), '--ks', ...
    ttff{1}(1:8), ttff{2}(1:8), '-kv', ...
    ttft{1}(1:8), ttft{2}(1:8), '--kv', ...
    ftff{1}(1:8), ftff{2}(1:8), '-k^', ...
    ftft{1}(1:8), ftft{2}(1:8), '--k^', 'MarkerSize', 8, 'LineWidth', 1);
p(2).LineWidth = 1.;
p(4).LineWidth = 1.;
p(6).LineWidth = 1.;
p(8).LineWidth = 1.;
...
saveas(fig, 'workprecisionzoomedin.pdf')
%%
