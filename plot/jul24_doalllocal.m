...
scheme_name = 'Implicit Euler, nofriction';
scheme_fname = 'runge_kutta3';
%scheme_fname = 'implicit_euler';
%scheme_fname = 'runge_kutta2';
%scheme_fname = 'radau';
fileprefix = ['/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/box' scheme_fname 'lnf' ];
