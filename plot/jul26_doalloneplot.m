...
figure();
p = loglog(radaufl2, radaufnd, '-o', radauilfl2, radauilfnd, '-o', radau1fl2, radau1fnd, '-o',  radau1ilfl2, radau1ilfnd, '-o', rk3fl2, rk3fnd, '-o', rk3ffl2, rk3ffnd, '-o', rk2fl2, rk2fnd, '-o', seefl2, seefnd, '-o',iefl2, iefnd, '-o', ieilfl2, ieilfnd, '-o', fiefl2, fiefnd, '-o', fieilfl2, fieilfnd, '-o',  bsfl2, bsfnd, '-o', bsffl2, bsffnd, '-o');
...
legend('Radau 3 Fixed', 'Radau 3 Fxd It Ltd', 'Radau 1 Fixed', 'Radau 1 Fxd It Ltd', 'RK3 EC', 'RK3 Fixed', 'RK2 Fixed', 'Semi-Explicit Euler Fixed', 'Implicit Euler EC','Implicit Euler EC It Lim', 'Implicit Euler Fixed', 'Implicit Euler Fxd It Lim', 'Bogacki Shampine3 EC', 'Bogacki Shampine3 Fixed');
