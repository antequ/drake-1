...
export FIXED=true
cd '/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/'
time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=3e-3 --fixed_step=$FIXED --accuracy 3e-3 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr25"  &

time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=1e-3 --fixed_step=$FIXED --accuracy 1e-3 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr3"  &

time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=3e-4 --fixed_step=$FIXED --accuracy 3e-4 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr35"  &

time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=1e-4 --fixed_step=$FIXED --accuracy 1e-4 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr4"  &

time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=3e-5 --fixed_step=$FIXED --accuracy 3e-5 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-6 --errors_filename="box${TEST_SCHEME}lerr45"   &
...
time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=3e-3 --fixed_step=$FIXED --accuracy 1e-4 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-7 --iteration_limit=true --errors_filename="box${TEST_SCHEME}fillerr3"  &
...
time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=5e-4 --fixed_step=$FIXED --accuracy 1e-6 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-7 --iteration_limit=true --errors_filename="box${TEST_SCHEME}fillerr4" &
...
time /home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark --simulation_time 2.5 --box_v_s 1e-4 --integration_scheme="$TEST_SCHEME" --target_realtime_rate="0" --autodiff="true" --max_time_step=1e-4 --fixed_step=$FIXED --accuracy 1e-8 --truth_integration_scheme="runge_kutta3" --truth_integration_step=1e-7 --iteration_limit=true --errors_filename="box${TEST_SCHEME}fillerr5" &
