...
v_s = 1e-4;
p = loglog(tttf{1}./v_s, tttf{2}, '-bo', ...
    tttt{1}./v_s, tttt{2}, '--bo', ...
...
p(6).LineWidth = 1.;
p(8).LineWidth = 1.;
p(1).MarkerFaceColor = [0.5,0.5,0.8];
p(2).MarkerFaceColor = [0.5,0.5,0.8];
...
saveas(fig1, '/home/antequ/integratorplots/WorkPrecisionImplicitEulerPointBlue.pdf')
% bottom right
fig2 = figure('Units', 'points', 'Position',  [1000 1000 width height],'PaperUnits', 'points','PaperSize',[width+8 height+8]);
p = loglog(tttf{1}(1:8)/v_s, tttf{2}(1:8), '-bo', ...
    tttt{1}(1:8)/v_s, tttt{2}(1:8), '--bo', ...
...
saveas(fig2, '/home/antequ/integratorplots/WorkPrecisionImplicitEulerPointZoomedBlue.pdf')
%%
