...
title(['Evaluations vs Error Plot, Hydroelastics']);
for i = 1:size(p,1)
    p(i).MarkerSize = 10;
...
fileprefix = ['/home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d.runfiles/drake/finalboxhydro' scheme_fname strf strc strn stri ];
result1 = nan(251, 10);
result2 = nan(251, 10);
result3 = nan(251, 10);
result4 = nan(251, 10);
