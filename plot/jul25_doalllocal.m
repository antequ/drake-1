...
scheme_name = 'Semi Explicit Euler fixed, friction';
...
figure(); plot(time, result35(:,[5 8])); title('position comparison step size 3e-4 vs truth')
figure(); plot(time, result4(:,[6 9])); title('velocity comparison step size next vs truth')
figure(); plot(time, result45(:,[6 9])); title('velocity comparison step size next next vs truth')
figure(); plot(time, result5(:,[6 9])); title('velocity comparison step size next^3 vs truth')
