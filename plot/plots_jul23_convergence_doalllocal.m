...
result25 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr25.csv', 1, 0);
result3 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr3.csv', 1, 0);
result35 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr35.csv', 1, 0);
result4 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr4.csv', 1, 0);
result45 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr45.csv', 1, 0);
result47 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr47.csv', 1, 0);
result48 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr48.csv', 1, 0);
result5 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr5.csv', 1, 0);
result55 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr55.csv', 1, 0);
result6 = csvread('/home/antequ/code/github/drake/bazel-bin/examples/box/integrator_benchmark.runfiles/drake/boxnlerr6.csv', 1, 0);
...
stepsizes = [1e-6 3e-6 1e-5 1.7e-5 2.4e-5 3e-5 1e-4 3e-4 1e-3 3e-3];
q_errs = [q_e6 q_e55 q_e5 q_e48 q_e47 q_e45 q_e4 q_e35 q_e3 q_e25];
q1_errs = [q1_e6 q1_e55 q1_e5 q1_e48 q1_e47 q1_e45 q1_e4 q1_e35 q1_e3 q1_e25];
q2_errs = [q2_e6 q2_e55 q2_e5 q2_e48 q2_e47 q2_e45 q2_e4 q2_e35 q2_e3 q2_e25];
fr_errs = [fr_e6 fr_e55 fr_e5 fr_e48 fr_e47 fr_e45 fr_e4 fr_e35 fr_e3 fr_e25];
...
q2_errs = [q2_e6 q2_e55 q2_e5 q2_e48 q2_e47 q2_e45 q2_e4 q2_e35 q2_e3 q2_e25];
fr_errs = [fr_e6 fr_e55 fr_e5 fr_e48 fr_e47 fr_e45 fr_e4 fr_e35 fr_e3 fr_e25];
l0_errs = [l0_e6 l0_e55 l0_e5 l0_e48 l0_e47 l0_e45 l0_e4 l0_e35 l0_e3 l0_e25];
l1_errs = [l1_e6 l1_e55 l1_e5 l1_e48 l1_e47 l1_e45 l1_e4 l1_e35 l1_e3 l1_e25];
l2_errs = [l2_e6 l2_e55 l2_e5 l2_e48 l2_e47 l2_e45 l2_e4 l2_e35 l2_e3 l2_e25];
