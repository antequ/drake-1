...
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-2 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}1" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-3 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}2" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-4 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}3" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-5 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}4" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-6 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}5" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-7 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}6" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-8 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}7" &
nice -n 2 time /home/antequ/code/github/drake/bazel-bin/examples/box2d/box2d --integration_scheme="$TEST_SCHEME"  --fixed_step=$FIXED --convergence_control=$CONV --full_newton=$FNR --target_realtime_rate="0" --iteration_limit=$ITLIM --max_time_step=1e-2 --accuracy 1e-9 --truth_integration_scheme="runge_kutta3" --truth_integration_step=3e-6 --use_hydroelastics_model --errors_filename="finalboxhydro${TEST_SCHEME}_${STRF}_${STRC}_${STRN}_${STRI}8" &
